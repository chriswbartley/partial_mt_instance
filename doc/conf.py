...
# -*- coding: utf-8 -*-
#
# partial_mt_instance documentation build configuration file, created by
...
sphinx_gallery_conf = {
    ...
    'doc_module': ('partial_mt_instance',),
...
htmlhelp_basename = 'partial_mt_instancedoc'
...
latex_documents = [
  ('index', 'partial_mt_instance.tex', 'partial_mt_instance Documentation',
...
man_pages = [
    ('index', 'partial_mt_instance', 'partial_mt_instance Documentation',
...
texinfo_documents = [
  ('index', 'partial_mt_instance', 'partial_mt_instance Documentation',
   'Christopher Bartley', 'partial_mt_instance', 'One line description of project.',
   'Miscellaneous'),
]
